...
\t";
    ...
    {
        return new Source("{# templates/message/index.html.twig #}
...
\t\t\t\t<div class=\"card bg-light mb-3 mt-5\" style=\"width: 800px\">
\t\t\t\t\t<div class=\"card-body\">
\t\t\t\t\t\t<div class=\"card-header mb-3\">Nouveau message</div> {{ form(form) }}.
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
\t{% endblock %}
", "message/index.html.twig", "C:\\Users\\Julien\\Documents\\Symfony\\forum\\templates\\message\\index.html.twig");
    }
}
