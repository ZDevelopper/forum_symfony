...
class __TwigTemplate_ab933908f05c256f5fb469ebe3c7cf6b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t<div class=\"card-body\">
\t\t\t\t\t\t<div class=\"card-header\">Liste des sujets du forum</div>
\t\t\t\t\t\t<table class=\"table\">
\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t<th>Sujets</th>
\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["sujets"]) || array_key_exists("sujets", $context) ? $context["sujets"] : (function () { throw new RuntimeError('Variable "sujets" does not exist.', 17, $this->source); })()));
...
";
    ...
    {
        return array (  117 => 22,  108 => 19,  105 => 18,  101 => 17,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
